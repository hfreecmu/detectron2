...
# what Harry added
_C.MASK_LOSS_WEIGHT = 1.0

_C.MODEL.LINE_ON = False
_C.LINE_LOSS_WEIGHT = 0.0

_C.MODEL.ROI_LINE_HEAD = CN()
_C.MODEL.ROI_LINE_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_LINE_HEAD.NAME = "LineRCNNConvUpsampleHead"
_C.MODEL.ROI_LINE_HEAD.NUM_FC = 2
_C.MODEL.ROI_LINE_HEAD.FC_DIM = 1024
_C.MODEL.ROI_LINE_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_LINE_HEAD.POOLER_TYPE = "ROIAlignV2"
_C.MODEL.ROI_LINE_HEAD.LINE_REG_WEIGHTS = (1.0, 1.0)

#for training aug
_C.INPUT.DOUBLE_FLIP = False
_C.INPUT.RANDOM_BRIGHTNESS = CN()
_C.INPUT.RANDOM_BRIGHTNESS.ENABLE = False
_C.INPUT.RANDOM_BRIGHTNESS.LOW = 0.8
_C.INPUT.RANDOM_BRIGHTNESS.HIGH = 1.2